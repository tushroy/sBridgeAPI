...
public class Configuration {
    ...
    * Global log tag
    */
    public final static String GLOBAL_LOG_TAG = "BridgeAPI";
    ...
    public boolean setToneSize(final int toneSize) {
        if(toneSize < Configuration.MIN_TONE_SIZE) {
            ...
            Log.w(Configuration.LOG_TAG, "Tone sizes over " + Configuration
    ...
    public static Configuration newAudibleConfiguration() {
        ...
        configuration.toneSize = 960;
        configuration.controlToneSize = 1920;
